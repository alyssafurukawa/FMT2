#' Place Figure Text update for MBQIP annual measures
#'
...
easy_just_annual <- function (data, axis_max=100, axis_min=0, invert=FALSE){

  data <- data %>%
    {if ("year" %ni% names(data)) dplyr::rename(.data=., year=annual_period) else .}
